...
Grafana handles the IdP `SessionIndex` for single logout, so logout requests can end the specific session provided by the IdP instead of ending all sessions for the user.
{{< /admonition >}}
