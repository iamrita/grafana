...
const logger = createMonitoringLogger('datasource.loki.querybuilder.parsing');
...
export function buildVisualQueryFromString(expr: string): Context {
  ...
  try {
    ...
    logger.logError(err instanceof Error ? err : new Error(String(err)), { context: 'buildVisualQueryFromString', expr });
