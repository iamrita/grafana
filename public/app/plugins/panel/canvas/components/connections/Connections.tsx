...
const logger = createLogger('CanvasConnections');
...
export class Connections {
  ...
  handleMouseEnter = (event: React.MouseEvent) => {
    ...
    if (!element) {
      logger.logger('noElement', false, 'No element found for connection');
      return;
    }
    ...
    if (this.isDrawingConnection) {
      ...
      if (!this.connectionSource) {
        logger.logger('noConnectionSource', false, 'No connection source available');
        return;
      }
    }
