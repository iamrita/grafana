...
const logger = createMonitoringLogger('features.canvas.runtime');
    ...
    switch (action) {
      ...
      case LayerActionID.Duplicate:
        if (element.item.id === 'frame') {
          logger.logInfo('Cannot duplicate frames yet', { action, elementName: element.options.name });
          return;
        }
      ...
      default:
        logger.logInfo('Unhandled action', { action, elementName: element.options.name });
        return;
    }
  };
