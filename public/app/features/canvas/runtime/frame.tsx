...
const logger = createLogger('canvasFrame');
    ...
    switch (action) {
      ...
      case LayerActionID.Duplicate:
        if (element.item.id === 'frame') {
          logger.logger('duplicateFrame', false, 'Cannot duplicate frames yet', { action, element: element.options.name });
          return;
        }
      ...
      default:
        logger.logger('unknownAction', false, 'Unknown layer action', { action, element: element.options.name });
        return;
    }
  };
