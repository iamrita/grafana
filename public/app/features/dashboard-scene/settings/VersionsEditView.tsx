...
const logger = createMonitoringLogger('dashboard-scene.versions-edit-view');
...
export class VersionsEditView extends SceneObjectBase<VersionsEditViewState> implements DashboardEditView {
  ...
  public fetchVersions = (append = false): void => {
    ...
    historySrv
      ...
      .catch((err) =>
        logger.logError(err instanceof Error ? err : new Error(String(err)), { action: 'fetchVersions' })
      )
