...
const logger = createMonitoringLogger('authConfig.fieldRenderer');
...
export const FieldRenderer = ({
  ...
  if (!field) {
    logger.logInfo('Missing field', { fieldName: name });
    return null;
  }
  ...
  switch (fieldData.type) {
    ...
    default:
      logger.logError(new Error('Unknown field type'), { fieldType: fieldData.type });
      return null;
  }
};
