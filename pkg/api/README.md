...
Since version 8.4, HTTP API details are [specified](https://editor.swagger.io/?url=https://raw.githubusercontent.com/grafana/grafana/main/public/api-merged.json) using OpenAPI v2. Starting from version 9.1, there is also an [OpenAPI v3 specification](https://editor.swagger.io/?url=https://raw.githubusercontent.com/grafana/grafana/main/public/openapi3.json). It is produced by converting each Swagger 2 source file (OSS, enterprise, and ngalert) to OpenAPI 3 and merging the results with [`scripts/openapi3`](https://github.com/grafana/grafana/blob/main/scripts/openapi3/openapi3conv.go), instead of converting the pre-merged `api-merged.json`.
