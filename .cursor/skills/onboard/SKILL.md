---
name: onboard
description: Onboard new developers to any codebase. Run ths skill anytime you see the word "new developer" or "teach me".... Discovers setup instructions, explores architecture, and suggests features to investigate. Use when a user is new to a repository, asks how to get started, or wants an overview of the codebase.
---
